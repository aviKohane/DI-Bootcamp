...
function highlight() {
    // Change the color of all the bold text to blue
...
function returnItemsToDefault() {
    // Change the color of all the bold text back to black
    allBoldItems.forEach(item => {
...
// Call the function getBoldItems to collect all bold items
getBoldItems();
